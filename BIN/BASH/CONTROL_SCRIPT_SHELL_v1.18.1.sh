...
#Validate if the Database's entered are not the same
#if [[ "${SOURCE_DB}" == "${TARGET_DB}" ]]
#then
#echo "CRITICAL ERROR: The source database and target database cannot be the same."
#exit 1
#fi

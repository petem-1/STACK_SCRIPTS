#!/bin/bash
#Control Script Version 1.18.2
#New in v1.18.2:
#  - Added send_email() function for alert notifications (STC15-783)
#  - Added exit status checks for scp, expdp, impdp (STC15-784)
#  - Added failure email for secure_copy, database_backup, database_import
#  - Added success email for database_backup on confirmed backup (STC15-785)
#---------------------------------------------------------------
...
Runner: ${RUNNER}
ORA_SID: ${ORA_SID}
Dump File: ${DMP_NAME}Archive: ${ARCHIVE}"
Archive: ${ARCHIVE}"  #NEW v1.18.2
      fi

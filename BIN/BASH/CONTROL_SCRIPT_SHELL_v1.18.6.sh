...
FUNCTION_OPTIONS="schedule_backup secure_copy backup_f_d database_backup database_import disk_utilization cleanup local_migration sql_schema_list quit"
